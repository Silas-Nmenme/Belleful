...
<head>
  ...
  <style>
    ...
    button { background: #667eea; color: white; padding: 12px 30px; border: none; border-radius: 5px; font-size: 16px; cursor: pointer; }
  </style>
</head>
<body>
  <div class="header">
  ...
  <div class="footer">
    <p>© 2024 Belleful. All rights reserved.</p>
  </div>
</body>
</html>
  `,
...
<head>
  ...
  <style>
    ...
    .total { font-size: 24px; font-weight: bold; color: #4CAF50; text-align: right; }
...
module.exports = { generateOTP, emailTemplates };
